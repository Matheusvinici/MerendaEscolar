...
@section('content')
    <div class="card-body login-card-body">
        <p class="login-box-msg">{{ __('Sistema de Gestão da Merenda Escolar - SEDUC') }}</p>
        ...
        <p class="mt-3 mb-1">
            {{ __('Se ainda não tem cadastro no sistema de gestão da merenda, cadastre-se clicando no botão abaixo.') }}
        </p>
