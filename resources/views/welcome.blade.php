...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Sistema de Gestão da Merenda Escolar">
    <title>SGME - Sistema de Gestão da Merenda Escolar</title>
    ...
    <main>
      <section>
        ...
        <div class="container col-xxl-8 px-4 py-5">
          <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
            ...
            <div id="objetivo" class="col-lg-6">
              <h1 class="display-5 fw-bold lh-1 mb-3">Sistema de Gestão da Merenda Escolar</h1>
              <p class="lead">Gerenciamento do fornecimento e distribuição da merenda escolar na Rede Municipal de Ensino de Juazeiro-BA</p>
        ...
        <div class="bg-dark text-secondary px-4 py-5 text-center">
          <div class="py-5">
            <h3 class="display-8 fw-bold text-white">Sistema de Gestão da Merenda Escolar (SGME)</h3>
